        ...
        <div className="main-container">
          ...
          <div className="full-width-p">
            <LeftText title={"Overview"} className="left-section">
              ...
              interactive experience for the viewers and 2) if we were to place
              it in a time capsule for 100 years how could we show the world as
              it is today. We were advised to make a poster but to me that did
              not at all convey the world as it is today. We are in a digital
              age, a world where you can connect to almost anyone anywhere at
              anytime. A world where all of the things we've learned and
              experiences we've had over the centuries are at the tips of our
              fingers. We can explore worlds, experience the past, and create
              our wildest dreams, all without even leaving our seats.
              <br />
              <br />
              ...
              educate the public and the future about endangered species. I
              decided to make a video game because to me that showed more of the
              21st century than a poster could ever show. And not only would
              this be more technologically relevant to today, it was a new
              challenge for me. It was something new to learn which was more way
              exciting to me than the familiar.
            </LeftText>
          </div>
